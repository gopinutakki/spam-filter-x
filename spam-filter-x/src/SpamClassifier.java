...
public class SpamClassifier {
    ...
    public static void main(String args[]) {
        ...
        */
        ...
        SpamClassifier classifier = new SpamClassifier(inputText, inputClasses, thisAttributeInfo, thisTextAttribute, thisClassAttribute, thisClassString);
    ...
    // constructor
    //
    SpamClassifier(String[] inputText, String[] inputClasses, FastVector attributeInfo, Attribute textAttribute, Attribute classAttribute, String classString) {
